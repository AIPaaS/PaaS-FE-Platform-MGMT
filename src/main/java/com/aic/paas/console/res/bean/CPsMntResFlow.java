...
/**
 * condition-table: 租户资源流水表[PS_MNT_RES_FLOW]
 */
public class CPsMntResFlow implements Condition {
	...
	/**
	 * condition-field: 所属资源[RES_ID] operate-Equal[=]
	 */
	private Long resId;


	/**
	 * condition-field: 所属资源[RES_ID] operate-In[in]
	 */
	private Long[] resIds;


	/**
	 * condition-field: 所属资源[RES_ID] operate-GTEqual[>=]
	 */
	private Long startResId;

	/**
	 * condition-field: 所属资源[RES_ID] operate-LTEqual[<=]
	 */
	...
	/**
	 * condition-field: 对应申请单[RES_APPLY_ID] operate-Equal[=]
	 */
	private Long resApplyId;


	/**
	 * condition-field: 对应申请单[RES_APPLY_ID] operate-In[in]
	 */
	private Long[] resApplyIds;


	/**
	 * condition-field: 对应申请单[RES_APPLY_ID] operate-GTEqual[>=]
	 */
	private Long startResApplyId;

	/**
	 * condition-field: 对应申请单[RES_APPLY_ID] operate-LTEqual[<=]
	 */
	private Long endResApplyId;
	...
	/**
	 * condition-field: 更新人[UPOR] operate-Like[like]
	 */
	private String upor;


	/**
	 * condition-field: 更新人[UPOR] operate-Equal[=]
	 */
	private String uporEqual;


	/**
	 * condition-field: 更新人[UPOR] operate-In[in]
	 */
	...
	public Long[] getResApplyIds() {
		return this.resApplyIds;
	}
	public void setResApplyIds(Long[] resApplyIds) {
		this.resApplyIds = resApplyIds;
	}


	public Long getStartResApplyId() {
		return this.startResApplyId;
	}
	public void setStartResApplyId(Long startResApplyId) {
		this.startResApplyId = startResApplyId;
	}


	public Long getEndResApplyId() {
		return this.endResApplyId;
	}
	public void setEndResApplyId(Long endResApplyId) {
		this.endResApplyId = endResApplyId;
	}
